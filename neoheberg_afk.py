...
# -*- coding: utf-8 -*-
"""
NeoHeberg AFK 广告挂机脚本- GitHub Actions 适配版
================================================
...
NH_MAX_ROUNDS = int(os.environ.get("NH_MAX_ROUNDS", "30")) # 最大执行轮次，0 为无限制
